...
class Registerprovider with ChangeNotifier {
  ...
  Future<Map<String, dynamic>> sendSignupRequest(String ccode, String phone, String email ,String firstname,String lastname,String uipass) async {
    try {
      _isLoading = true;
      notifyListeners();
      ...
      var response = await http.post(
        Uri.parse("https://my.africallconnect.com/munya_api/billing_auto_register/otp_send_msg_api.php"),
        headers: {
      ...
      if (kDebugMode) {
        print("Response Create Account  ===========> ${response.body}");
      }
