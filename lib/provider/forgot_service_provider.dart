...
class ForgotServiceProvider with ChangeNotifier {
  bool _isLoading = false;
  bool get isLoading => _isLoading;

  Future<Map<String, dynamic>> sendForgotRequest(String email) async {
    try {
      _isLoading = true;
      notifyListeners();
      ...
      String a = asHex(utf8.encode(encryptedEmail));

      var response = await http.post(
        Uri.parse("http://my.africallconnect.com/munya_api/billing_forget/billing_forget_password.php"),
        headers: {
      ...
      if (kDebugMode) {
        print("Response Forgot Account  ===========> ${response.body}");
      }
